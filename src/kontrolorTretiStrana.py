...
def hide_ikona():
    ...
    KontrolorStranaDva.stavSkladu_ikona.config(bg='#c3c3c3')
...
def Zaloha(ctverec):
    ...
    def otevritEmail():
        ...
        window_width = 465
        window_height = 300
        screen_width = kontrolorStranajedna.Kontrola.winfo_screenwidth()
        screen_height = kontrolorStranajedna.Kontrola.winfo_screenheight()
        ...
        for email in mycursor:
            for j in range(len(email)):
                ...
                e = Label(otevrit, width=8, fg='black', borderwidth=3, relief='ridge', anchor="w", text=email[j],
                          bg=row_bg_color)
    ...
    def search_zaznam_sklad():
        main_frame = tk.Frame(kontrolorStranajedna.Kontrola, highlightthickness=2)
        main_frame.pack_propagate(False)
        main_frame.pack(side=tk.RIGHT)
        ...
        if search_text_var.get() == '':
            ...
            if myRows == None:
                ...
                main_frame = tk.Frame(kontrolorStranajedna.Kontrola, highlightbackground='black',
                ...
                for email in myRows:
                    for j in range(len(email)):
                        ...
                        if i == 0:
                            ...
                            label_fg_color = 'black'
                            label_bg_color = row_bg_color
                        e = Label(main_frame, width=7, text='Id', borderwidth=5, relief='ridge', anchor='w',
                                  bg=label_bg_color,
                                  fg=label_fg_color)
                        e.grid(row=0, column=0)
                        ...
                        e = Label(main_frame, width=8, fg='black', borderwidth=3, relief='ridge', anchor="w",
                                  text=email[j],
                                  bg=row_bg_color)
                        e.grid(row=i, column=j)
    ...
    main_frame.configure(width=500, height=495)
    messageLabel = Label(kontrolorStranajedna.Kontrola, text='Zadejte, komu byl Email zaslán', bg='light grey')
...
# --------------------------------------------------------------------------------------------
# Button k poznamkam
poznamkyButton = Button(kontrolorStranajedna.Kontrola, text='Poznámky', font=('Open Sans', 13, 'bold'),
                        width=19,fg='black', bg='white', activeforeground='grey', activebackground='white', cursor='hand2',
                        command=lambda: ikona(poznamky_ikona, poznamky(kontrolorStranajedna.main_frame)))
poznamkyButton.pack()
poznamkyButton.place(x=30, y=420)

poznamky_ikona = Label(kontrolorStranajedna.Kontrola, text='', bg='#c3c3c3')
poznamky_ikona.place(x=25, y=419, height=35)
# --------------------------------------------------------------------------------------------
#button pro insert
zalohaButton = Button(kontrolorStranajedna.Kontrola, text='Zálohy', font=('Open Sans', 13, 'bold'),
                      fg='black', bg='white', activeforeground='grey', activebackground='white', cursor='hand2'
                      , bd=1, width=19, command=lambda: ikona(zaloha_ikona, Zaloha(kontrolorStranajedna.main_frame)))
zalohaButton.pack()
zalohaButton.place(x=30, y=160)

zaloha_ikona = Label(kontrolorStranajedna.Kontrola, text ='', bg='#c3c3c3')
zaloha_ikona.place(x=25, y=159, height=35)


kontrolorStranajedna.Kontrola.mainloop()